/**
 * Hometown Courses Page
 *
 * Displays tour courses within 180 miles of player's hometown.
...
export default async function HometownCoursesPage({ params }: HometownCoursesPageProps) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                This page displays placeholder data. Real hometown course proximity data will be
      ...
      <Card>
        <CardHeader>
          <CardTitle>Hometown Courses</CardTitle>
          <CardDescription>
            PGA Tour courses within 180 miles of hometown
          </CardDescription>
        </CardHeader>
        <CardContent>
